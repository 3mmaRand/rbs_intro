...
In RStudio, [set your working directory](pics/menusetwd.png) to the folder you created above<sup>1</sup>.  

--

Make a [new script](pics/newscript.png) file called RBS_am.R to carry out the rest of the work.  

<small>[1] A better way to work longer term is to use [Projects](https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects) </small>
...
Wickham, H. & Grolemund, G. (2016) R for Data Science. O’Reilly. http://r4ds.had.co.nz/

Wickham, H. (2017). tidyverse: Easily Install and Load the 'Tidyverse'. R package version 1.2.1. https://CRAN.R-project.org/package=tidyverse

Wilkinson, L. (2005) The Grammar of Graphics. Statistics and Computing. 2nd ed. New York, NY: Springer
...
#### Twitter: [@er13_r](https://twitter.com/er13_r) &nbsp;&nbsp;&nbsp;&nbsp; github: 3mmarand
